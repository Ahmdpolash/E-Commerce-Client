            ...
            <ul className="">
                ...
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">
                      A multivendor ecommerce platform is an online marketplace
                      where multiple sellers/vendors can list and sell their
                      products/services on a single website. It allows customers
                      to browse and purchase items from various sellers within
                      one platform.
                    </p>
                  </div>
              ...
              <li className="text-left mb-10">
                ...
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">
                      To become a seller on our platform, you need to sign up as
                      a vendor. Once registered, our team will review your
                      application, and upon approval, you'll gain access to list
                      your products and manage your store through our vendor
                      dashboard.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">
                      What are the benefits of selling on a multivendor
                      platform?
                    </h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">
                      Selling on a multivendor platform offers several
                      advantages, including access to a larger customer base,
                      reduced marketing costs, simplified store management, and
                      increased visibility through collective marketing efforts.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                    <svg
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">
                      How are payments processed on your platform?
                    </h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">
                      We use a secure payment gateway to process all
                      transactions on our platform. Customers can make payments
                      using various methods such as credit/debit cards, digital
                      wallets, and bank transfers. Once a purchase is made, the
                      payment is securely transferred to the seller's account
                      after deducting any applicable fees.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                    <svg
