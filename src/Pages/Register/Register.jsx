...
import { FaAngleRight, FaEye, FaFacebookF, FaHome } from "react-icons/fa";
  ...
  return (
    <div>
      ...
      <div className="bg-[#F1F5F6]">
        <h1 className="pl-11 pt-4 flex items-center gap-2">
          {" "}
          <FaHome className="text-[22px] text-[#f94336]" />{" "}
          <FaChevronRight className="text-[18px] text-[#f94336]" />
          <span className="font-semibold"> {path.pathname.slice(1, 10).toUpperCase()}</span>
        </h1>
            ...
            <div className="grid grid-cols-1 items-center relative lg:grid-cols-2 mx-auto bg-white rounded-md">
              <div className="px-8 py-8 ">
                ...
                <div className="relative">
                  ...
                  <div
                    className={` ${role === "seller" ? "hidden" : "block"} `}
                  >
