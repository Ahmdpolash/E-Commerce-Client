    ...
    <div className="bg-[#F6F6F5]">
      ...
      <Container>
        <div className="grid grid-cols-1 gap-4  lg:grid-cols-4">
          ...
          <div
        onClick={handleOpen}
        className={`bg-[#F85606] cursor-pointer  -left-0 top-[153px] z-30 fixed inline px-1 py-4 text-white ${isOpen ? 'hidden' : ''}`}
      >
        <FaAngleRight size={22} />
      </div>
      <div
        onClick={handleClose}
        className={`bg-red-700 cursor-pointer left-[58%] top-8 fixed inline px-4 p-2 z-50 text-white ${isOpen ? '' : 'hidden'}`}
      >
        <FaTimes size={24} />
      </div>
            ...
            <div
              ...
              } top-0 transition-all duration-500 left-0 z-[9999] w-[280px] fixed overflow-auto h-full border-r-2 shadow-lg p-4 bg-white`}
            >
              <div className="flex justify-between border-b-2 border-gray-200  py-1 items-center">
                <h1 className="text-xl text-gray-600 font-semibold ">
                  Categories
