...
const Shop = () => {
  ...
  const handleStyle = {
    ...
    border: "2px solid #DC2626", // Add a border
      ...
      <Container>
        <div className="grid grid-cols-1 gap-4  lg:grid-cols-4">
          <div className="col-span-1 border-2 bg-white px-5 py-4">
            ...
            <h1 className="text-2xl mb-3 border-b-2 border-gray-200 py-1 text-[#4b5563] font-semibold">
              Price
            </h1>
            ...
            <div className="px-2 space-y-2 ">
              ...
              <div>
                ...
                <button class="px-5 my-3 w-full text-white py-2 text-center rounded bg-red-600 border-gray-400">Filter</button>
          </div>
