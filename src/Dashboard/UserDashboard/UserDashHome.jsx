...
const UserDashHome = () => {
  return (
    <div className="">
      <div className="grid grid-cols-1 flex-wrap md:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <div className="bg-white p-4 mt-5 example w-[390px] md:w-[740px] lg:w-full rounded-md">
